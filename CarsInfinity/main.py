...
menu = pygame_menu.Menu('CARS INFINITY', 800, 600,
...
#class name Beta name game CarRacing
class CarRacing:
    def __init__(self):
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Cars Infinity By Abylkair and Tamerlan')
        self.run_car()
    ...
    def display_message(self, msg):
        font = pygame.font.SysFont("", 12, True)
